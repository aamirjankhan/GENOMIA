...
class Window(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("GENOMA (AJK COMP)")
        self.setGeometry(450,100,700,950)
        self.setStyleSheet('''
    ...
    def UI(self):
        ...
        GC_Content.setStyleSheet(style.button())
        GC_Content.clicked.connect(self.getGCContent)
        GC_Skew=QPushButton("GC Skew")
        GC_Skew.setStyleSheet(style.button())
